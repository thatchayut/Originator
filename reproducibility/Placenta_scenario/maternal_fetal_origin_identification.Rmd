...
setwd("/home/qhhuang/scRNA_PE/Analysis_4_28_2022/")
library(clustree)
```

###impute SNPs from bam files for all 8 samples

#### Use popscle to recover the maternal and fetus origin (demutiplexing)

```
sbatch /home/qhhuang/scRNA_PE/Analysis_11_22_2021/popscle_PNAS.sbat
```

#### Integrate PNAS with Own
