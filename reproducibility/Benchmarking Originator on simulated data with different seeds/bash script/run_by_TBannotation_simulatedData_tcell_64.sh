#!/bin/bash
#SBATCH --job-name=originator_TBannotation_simulatedData_tcell_64
#SBATCH --nodes=1
...
/sw/pkgs/arc/stacks/gcc/10.3.0/R/4.3.1/bin/Rscript src/Main.R \
  --name 'TBannotation_simulatedData_tcell_64' \
  ...
  --output '/nfs/dcmb-lgarmire/thatchau/originator_GB_revision/results/simulatedData_seeds/tcell/64' \
