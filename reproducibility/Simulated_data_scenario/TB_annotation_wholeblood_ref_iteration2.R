...
pdf(file = "E:/Tays_workspace/Demultiplexing_PDAC_new_analysis/artificial_tissue_blood_mixing_wholeblood_ref/results/iteration_2/Wholeblood_Tcells_UMAP_d10_query_ref_dist.pdf", width = 15, height = 6)
...
pdf(file = "E:/Tays_workspace/Demultiplexing_PDAC_new_analysis/artificial_tissue_blood_mixing_wholeblood_ref/results/iteration_2/Wholeblood_Tcells_UMAP_d10_query_ref_dist_median.pdf", width = 4, height = 6)
...
pdf(file = "E:/Tays_workspace/Demultiplexing_PDAC_new_analysis/artificial_tissue_blood_mixing_wholeblood_ref/results/iteration_2/Wholeblood_Tcells_UMAP_d10_query_ref_dist_median_nobreak.pdf", width = 4, height = 6)
...
save(km.res3, file = "E:/Tays_workspace/Demultiplexing_PDAC_new_analysis/artificial_tissue_blood_mixing_wholeblood_ref/results/iteration_2/Wholeblood_Tcells_UMAP_d10_query_ref_dist.RData")
...
pdf(file = "E:/Tays_workspace/Demultiplexing_PDAC_new_analysis/artificial_tissue_blood_mixing_wholeblood_ref/results/iteration_2/Wholeblood_monocyte_UMAP_d10_query_ref_dist.pdf", width = 15, height = 6)
print(pheatmap(temp4, annotation_names_col = FALSE, annotation_names_row = FALSE, show_rownames = FALSE, show_colnames = FALSE, main = paste0(ct), annotation_row = km.res3, cluster_rows = FALSE, color = my.color1, breaks = my.break1))
dev.off()
...
temp4$dist_median = rowMedians(as.matrix(temp4[,c(-1)]))
temp5 <- temp4[, "dist_median", drop = F]
pdf(file = "E:/Tays_workspace/Demultiplexing_PDAC_new_analysis/artificial_tissue_blood_mixing_wholeblood_ref/results/iteration_2/Wholeblood_monocyte_UMAP_d10_query_ref_dist_median.pdf", width = 4, height = 6)
print(pheatmap(temp5, annotation_names_col = FALSE, annotation_names_row = FALSE, show_rownames = FALSE, show_colnames = FALSE, main = paste0(ct), annotation_row = km.res3, cluster_rows = FALSE, cluster_cols = FALSE, color = my.color1, breaks = my.break1))
dev.off()

pdf(file = "E:/Tays_workspace/Demultiplexing_PDAC_new_analysis/artificial_tissue_blood_mixing_wholeblood_ref/results/iteration_2/Wholeblood_monocyte_UMAP_d10_query_ref_dist_median_nobreak.pdf", width = 4, height = 6)
print(pheatmap(temp5, annotation_names_col = FALSE, annotation_names_row = FALSE, show_rownames = FALSE, show_colnames = FALSE, main = paste0(ct), annotation_row = km.res3, cluster_rows = FALSE, cluster_cols = FALSE))
dev.off()
...
save(km.res3, file = "E:/Tays_workspace/Demultiplexing_PDAC_new_analysis/artificial_tissue_blood_mixing_wholeblood_ref/results/iteration_2/Wholeblood_monocyte_UMAP_d10_query_ref_dist.RData")
...
pdf(file = "E:/Tays_workspace/Demultiplexing_PDAC_new_analysis/artificial_tissue_blood_mixing_wholeblood_ref/results/iteration_2/Wholeblood_bcell_UMAP_d10_query_ref_dist.pdf", width = 15, height = 6)
print(pheatmap(temp4, annotation_names_col = FALSE, annotation_names_row = FALSE, show_rownames = FALSE, show_colnames = FALSE, main = paste0(ct), annotation_row = km.res3, cluster_rows = FALSE, color = my.color1, breaks = my.break1))
dev.off()
...
temp4$dist_median = rowMedians(as.matrix(temp4[,c(-1)]))
temp5 <- temp4[, "dist_median", drop = F]
pdf(file = "E:/Tays_workspace/Demultiplexing_PDAC_new_analysis/artificial_tissue_blood_mixing_wholeblood_ref/results/iteration_2/Wholeblood_bcell_UMAP_d10_query_ref_dist_median.pdf", width = 4, height = 6)
print(pheatmap(temp5, annotation_names_col = FALSE, annotation_names_row = FALSE, show_rownames = FALSE, show_colnames = FALSE, main = paste0(ct), annotation_row = km.res3, cluster_rows = FALSE, cluster_cols = FALSE, color = my.color1, breaks = my.break1))
dev.off()

pdf(file = "E:/Tays_workspace/Demultiplexing_PDAC_new_analysis/artificial_tissue_blood_mixing_wholeblood_ref/results/iteration_2/Wholeblood_bcell_UMAP_d10_query_ref_dist_median_nobreak.pdf", width = 4, height = 6)
print(pheatmap(temp5, annotation_names_col = FALSE, annotation_names_row = FALSE, show_rownames = FALSE, show_colnames = FALSE, main = paste0(ct), annotation_row = km.res3, cluster_rows = FALSE, cluster_cols = FALSE))
dev.off()
...
save(km.res3, file = "E:/Tays_workspace/Demultiplexing_PDAC_new_analysis/artificial_tissue_blood_mixing_wholeblood_ref/results/iteration_2/Wholeblood_bcell_UMAP_d10_query_ref_dist.RData")


##collect all data
temp_meta <- NULL

load("E:/Tays_workspace/Demultiplexing_PDAC_new_analysis/artificial_tissue_blood_mixing_wholeblood_ref/results/iteration_2/Wholeblood_Tcells_UMAP_d10_query_ref_dist.RData", verbose = T)
temp_meta <- rbind(temp_meta, km.res3)
load("E:/Tays_workspace/Demultiplexing_PDAC_new_analysis/artificial_tissue_blood_mixing_wholeblood_ref/results/iteration_2/Wholeblood_monocyte_UMAP_d10_query_ref_dist.RData", verbose = T)
temp_meta <- rbind(temp_meta, km.res3)
load("E:/Tays_workspace/Demultiplexing_PDAC_new_analysis/artificial_tissue_blood_mixing_wholeblood_ref/results/iteration_2/Wholeblood_bcell_UMAP_d10_query_ref_dist.RData", verbose = T)
temp_meta <- rbind(temp_meta, km.res3)


save(temp_meta, file = "E:/Tays_workspace/Demultiplexing_PDAC_new_analysis/artificial_tissue_blood_mixing_wholeblood_ref/results/iteration_2/tissue_blood_annotation_usingWholeBlood.RData")
...
saveRDS(data_TB_annotation, file = "E:/Tays_workspace/Demultiplexing_PDAC_new_analysis/artificial_tissue_blood_mixing_wholeblood_ref/results/iteration_2/data_merged_tissue_blood_residents_DEMO_TB_TuN_annotation_usingWholeblood.rds")

write.csv(data_TB_annotation@meta.data, "E:/Tays_workspace/Demultiplexing_PDAC_new_analysis/artificial_tissue_blood_mixing_wholeblood_ref/results/iteration_2/meta_data_merged_tissue_blood_residents_DEMO_TB_TuN_annotation_usingWholeblood.csv")

# Write out predictions
## T-cell
data_TB_annotation_tcell <- subset(data_TB_annotation, subset = final_annotation == "T-cell")
write.csv(data_TB_annotation_tcell@meta.data, "E:/Tays_workspace/Demultiplexing_PDAC_new_analysis/artificial_tissue_blood_mixing_wholeblood_ref/results/iteration_2/meta_data_merged_tissue_blood_residents_DEMO_TB_TuN_annotation_usingWholeblood_tcell.csv")

## Monocyte
data_TB_annotation_monocyte <- subset(data_TB_annotation, subset = final_annotation == "Monocyte")
write.csv(data_TB_annotation_monocyte@meta.data, "E:/Tays_workspace/Demultiplexing_PDAC_new_analysis/artificial_tissue_blood_mixing_wholeblood_ref/results/iteration_2/meta_data_merged_tissue_blood_residents_DEMO_TB_TuN_annotation_usingWholeblood_monocyte.csv")

## B-cell
data_TB_annotation_Bcell <- subset(data_TB_annotation, subset = final_annotation == "B-cell")
write.csv(data_TB_annotation_Bcell@meta.data, "E:/Tays_workspace/Demultiplexing_PDAC_new_analysis/artificial_tissue_blood_mixing_wholeblood_ref/results/iteration_2/meta_data_merged_tissue_blood_residents_DEMO_TB_TuN_annotation_usingWholeblood_Bcell.csv")
...
write.csv(data_TB_annotation_commonImmune@meta.data, "E:/Tays_workspace/Demultiplexing_PDAC_new_analysis/artificial_tissue_blood_mixing_wholeblood_ref/results/iteration_2/meta_data_merged_tissue_blood_residents_DEMO_TB_TuN_annotation_usingWholeblood_commonImmune.csv")
